            ...
            <div>
                <div>
                    ...
                    <div class="text-center mt-4 flex flex-col">
                        <p class="font-bold tracking-normal md:text-1xl lg:text-[24px]"
                        >
                        Mark Agbayani
                        
                        </p>
                        <p class="text-sky-900 uppercase font-medium flex items-center justify-center gap-1 flex-row mt-2 text-[9px] md:text-[10px] lg:text-[12px]"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#0c4a6e" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-map-pinned-icon lucide-map-pinned"><path d="M18 8c0 3.613-3.869 7.429-5.393 8.795a1 1 0 0 1-1.214 0C9.87 15.429 6 11.613 6 8a6 6 0 0 1 12 0"/><circle cx="12" cy="8" r="2"/><path d="M8.714 14h-3.71a1 1 0 0 0-.948.683l-2.004 6A1 1 0 0 0 3 22h18a1 1 0 0 0 .948-1.316l-2-6a1 1 0 0 0-.949-.684h-3.712"/></svg>
                        Quezon City</p>
                        <div class="mt-3 flex gap-1 justify-center items-center">
                            <p class="border-gray-400 border-1 text-center p-1 rounded-full bg-gray-100 text-[9px] md:text-[10px] lg:text-[12px]">4th Year</p>
                            <p class="border-gray-400 border-1 text-center p-1 rounded-full bg-gray-100 text-[9px] md:text-[10px] lg:text-[12px]">Developer Intern</p>
                        </div>
                    </div>
                </div>
            </div>
